...
/* 确保声明 SUSFS 相关函数，防止 implicit declaration 报错 */
#ifdef CONFIG_KSU_SUSFS
extern bool susfs_is_current_is_sus_status(void);
#else
static inline bool susfs_is_current_is_sus_status(void) { return false; }
#endif
